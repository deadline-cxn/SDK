...
class CDRGObjectSkyPlane : public CDRGObject {

public:
	CDRGObjectSkyPlane();
	virtual ~CDRGObjectSkyPlane();
	...
	HRESULT Init(	CDRGWrapper *pDRGWrapper,
					...
					float		atmosphereradius= 110.0f,
					float		h_tilefactor		= 1.0f,
					float		v_tilefactor		= 1.0f,
...
private:
	...
	float		m_fHTileFactor;
	float		m_fVTileFactor;
