// DRGObjectCone.h - Created with DR&E AppWizard 1.0B9
// ------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------
//
// Author: Kim Pallister. Originally modified (much) from Mike Rohman's Cone class
// 
////////////////////////////////////////////////////////////////////////////////////////

class CDRGObjectCone : public CDRGObject {

public:
	CDRGObjectCone();
	virtual ~CDRGObjectCone();
	
	
	// Initialize a Cone object (center, radius, tesselation, rotation)
