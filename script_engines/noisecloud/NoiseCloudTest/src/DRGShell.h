// DRGShell.h - Created with DR&E AppWizard 1.0B9
// ------------------------------------------------------------------------------------
...
#include "Objects\DRGObjectCube.h"
#include "Objects\DRGObjectCone.h"
#include "Objects\DRGObjectSphere.h"
#include "Objects\DRGObjectXYZAxis.h"
#include "Objects\DRGObjectSkyPlane.h"

#include "Resource.h"
#include "NoiseCloudTest.h"
...
// Defines
#define	CLASSNAME	"DRGAppWizard_Class"	// Used in Init()
#define WINDOWNAME	"Intel DRG D3D Appwizard Sample"
