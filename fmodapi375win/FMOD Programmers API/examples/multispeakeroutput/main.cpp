    ...
    */
    ...
    switch (speakermode)
    {
        case FMOD_SPEAKERMODE_MONO    :
        {
            ...
            printf("Most functionality of this demo is only realized with FMOD_SPEAKERMODE_4POINT1\n");
            printf("and above.\n");
            break;
        }
        ...
        case FMOD_SPEAKERMODE_4POINT1 :
        {
            printf("Using control panel speaker mode : QUAD surround.\n");
            printf("Side left and right mix will be disabled.\n");
            printf("Rear left and right mix will be combined and sent to rear speaker.\n");
            break;
        }
    ...
    if (speakermode >= FMOD_SPEAKERMODE_4POINT1)
    {
