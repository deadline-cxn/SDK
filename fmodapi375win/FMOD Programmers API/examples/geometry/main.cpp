...
void init(void)
{
    ...
    */
    ...
    result = fmodSystem->init(100, (FMOD_INITFLAGS)(FMOD_INIT_NORMAL | FMOD_INIT_3D_RIGHTHANDED), 0);
    ERRCHECK(result);
  
    // Load sounds
    result = fmodSystem->createSound("../media/drumloop.wav", FMOD_HARDWARE | FMOD_3D, 0, &sounds[0]);
    ERRCHECK(result);
    ...
    result = fmodSystem->createSound("../media/wave.mp3", FMOD_HARDWARE | FMOD_3D, 0, &sounds[1]);
    ERRCHECK(result);
    ...
    result = fmodSystem->createSound("../media/jaguar.wav", FMOD_HARDWARE | FMOD_3D, 0, &sounds[2]);
    ERRCHECK(result);
    ...
    result = fmodSystem->createSound("../media/swish.wav", FMOD_HARDWARE | FMOD_3D, 0, &sounds[3]);
    ERRCHECK(result);
	...
	texture = loadTexture("../media/texture.raw");		
