...
namespace pitchdetection
{
	public class PitchDetection : System.Windows.Forms.Form
	{
        ...
        private void comboBoxRecord_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            ERRCHECK(result);
            result = system.setSoftwareFormat(OUTPUTRATE, FMOD.SOUND_FORMAT.PCM16, 1, 0);
            ERRCHECK(result);

            result = system.init(32, FMOD.INITFLAG.NORMAL, (IntPtr)null);
            ERRCHECK(result);

            result = system.getSoftwareFormat(ref outputfreq, ref format, ref temp, ref temp, ref temp);
            ERRCHECK(result);
            ...
            */
            ...
            result = system.createSound(null, (FMOD.MODE._2D | FMOD.MODE.SOFTWARE | FMOD.MODE.LOOP_NORMAL | FMOD.MODE.OPENUSER), ref exinfo, ref sound);
            ERRCHECK(result);
