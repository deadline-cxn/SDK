...
function FMOD_System_SetSoftwareFormat      (system: FMOD_SYSTEM; samplerate: Integer; format: FMOD_SOUND_FORMAT; numoutputchannels: Integer; maxinputchannels: Integer): FMOD_RESULT; stdcall;
function FMOD_System_GetSoftwareFormat      (system: FMOD_SYSTEM; var samplerate: Integer; var format: FMOD_SOUND_FORMAT; var numoutputchannels: Integer; var maxinputchannels: Integer; var bits: Integer): FMOD_RESULT; stdcall;
...
function FMOD_System_SetProxy               (system: FMOD_SYSTEM; const proxy: PChar): FMOD_RESULT; stdcall;
function FMOD_System_GetProxy               (system: FMOD_SYSTEM; proxy: PChar; proxylen: Integer): FMOD_RESULT; stdcall;
...
function FMOD_Sound_GetFormat               (sound: FMOD_SOUND; var type_: FMOD_SOUND_TYPE; var format: FMOD_SOUND_FORMAT; var channels: Integer): FMOD_RESULT; stdcall;
...
(*
     Channelgroup master volume.  (scales the current volumes, does not overwrite)
*)
...
(*
     Channelgroup manipulation functions.  (overwrites whatever settings the channels had)
*)

function FMOD_ChannelGroup_Stop             (channelgroup: FMOD_CHANNELGROUP): FMOD_RESULT; stdcall;
function FMOD_ChannelGroup_SetPaused        (channelgroup: FMOD_CHANNELGROUP; paused: FMOD_BOOL): FMOD_RESULT; stdcall;
function FMOD_ChannelGroup_SetFrequency     (channelgroup: FMOD_CHANNELGROUP; frequency: Single): FMOD_RESULT; stdcall;
function FMOD_ChannelGroup_SetPan           (channelgroup: FMOD_CHANNELGROUP; pan: Single): FMOD_RESULT; stdcall;
function FMOD_ChannelGroup_SetMute          (channelgroup: FMOD_CHANNELGROUP; mute: FMOD_BOOL): FMOD_RESULT; stdcall;
function FMOD_ChannelGroup_SetReverbProperties(channelgroup: FMOD_CHANNELGROUP; const prop: FMOD_REVERB_CHANNELPROPERTIES): FMOD_RESULT; stdcall;
function FMOD_ChannelGroup_Set3DAttributes  (channelgroup: FMOD_CHANNELGROUP; const pos: FMOD_VECTOR; const vel: FMOD_VECTOR): FMOD_RESULT; stdcall;
...
function FMOD_System_SetProxy               ; external FMOD_DLL;
function FMOD_System_GetProxy               ; external FMOD_DLL;
...
function FMOD_ChannelGroup_SetPaused        ; external FMOD_DLL;
function FMOD_ChannelGroup_SetFrequency     ; external FMOD_DLL;
function FMOD_ChannelGroup_SetPan           ; external FMOD_DLL;
function FMOD_ChannelGroup_SetMute          ; external FMOD_DLL;
function FMOD_ChannelGroup_SetReverbProperties; external FMOD_DLL;
function FMOD_ChannelGroup_Set3DAttributes  ; external FMOD_DLL;
