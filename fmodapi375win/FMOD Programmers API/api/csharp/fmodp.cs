...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00040035;
        public const string dll    = "../../api/fmodexp.dll";
    }
    ...
    */
    public enum MODE
    {
        ...
        _3D_HEADRELATIVE    = 0x00040000,  /* Make the sound's position, velocity and orientation relative to the listener's position, velocity and orientation. */
        _3D_WORLDRELATIVE   = 0x00080000,  /* Make the sound's position, velocity and orientation absolute. (default) */
    ...
    */
    public class System
    {
        ...
        public RESULT getSoftwareFormat      (ref int samplerate, ref SOUND_FORMAT format, ref int numoutputchannels, ref int maxinputchannels, ref int bits)
        {
            return FMOD_System_GetSoftwareFormat(systemraw, ref samplerate, ref format, ref numoutputchannels, ref maxinputchannels, ref bits);
        }
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_SetSoftwareFormat      (IntPtr system, int samplerate, SOUND_FORMAT format, int numoutputchannels, int maxinputchannels);
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_System_GetSoftwareFormat      (IntPtr system, ref int samplerate, ref SOUND_FORMAT format, ref int numoutputchannels, ref int maxinputchannels, ref int bits);        
        [DllImport (VERSION.dll)]
    ...
    */
    public class ChannelGroup
    {
        ...
        public RESULT setFrequency           (float frequency)
        {
            return FMOD_ChannelGroup_SetFrequency(channelgroupraw, frequency);
        }
        public RESULT setPan                 (float pan)
        {
            return FMOD_ChannelGroup_SetPan(channelgroupraw, pan);
        }
        public RESULT setMute                (bool mute)
        {
            return FMOD_ChannelGroup_SetMute(channelgroupraw, mute);
        }
        public RESULT setReverbProperties    (ref REVERB_CHANNELPROPERTIES prop)
        {
            return FMOD_ChannelGroup_SetReverbProperties(channelgroupraw, ref prop);
        }
        public RESULT set3DAttributes        (ref VECTOR pos, ref VECTOR vel)
        {
            return FMOD_ChannelGroup_Set3DAttributes(channelgroupraw, ref pos, ref vel);
        }
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_SetFrequency     (IntPtr channelgroup, float frequency);
        [DllImport (VERSION.dll)]
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_SetReverbProperties(IntPtr channelgroup, ref REVERB_CHANNELPROPERTIES prop);
        [DllImport (VERSION.dll)]
