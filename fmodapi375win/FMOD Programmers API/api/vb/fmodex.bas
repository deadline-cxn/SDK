...
Public Declare Function FMOD_System_SetSoftwareFormat Lib "fmodex.dll" (ByVal system As Long, ByVal samplerate As Long, ByVal format As FMOD_SOUND_FORMAT, ByVal numoutputchannels As Long, ByVal maxinputchannels As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetSoftwareFormat Lib "fmodex.dll" (ByVal system As Long, ByRef samplerate As Long, ByRef format As FMOD_SOUND_FORMAT, ByRef numoutputchannels As Long, ByRef maxinputchannels As Long, ByRef bits As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_SetFrequency Lib "fmodex.dll" (ByVal channelgroup As Long, ByVal frequency As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_SetPan Lib "fmodex.dll" (ByVal channelgroup As Long, ByVal Pan As Single) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_SetReverbProperties Lib "fmodex.dll" (ByVal channelgroup As Long, ByRef prop As FMOD_REVERB_CHANNELPROPERTIES) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_GetSpectrum Lib "fmodex.dll" (ByVal hannelgroup As Long, ByRef spectrumarray As Single, ByVal numvalues As Long, ByVal channeloffset As Long, ByVal windowtype As FMOD_DSP_FFT_WINDOW) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_GetOutput Lib "fmodex.dll" (ByVal dsp As Long, ByVal ndex As Long, ByRef output As Long) As FMOD_RESULT
