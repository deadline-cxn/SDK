...
Public Const FMOD_VERSION As Long = &H40035
...
Public Declare Function FMOD_System_SetSoftwareFormat Lib "fmodexp.dll" (ByVal system As Long, ByVal samplerate As Long, ByVal format As FMOD_SOUND_FORMAT, ByVal numoutputchannels As Long, ByVal maxinputchannels As Long) As FMOD_RESULT
Public Declare Function FMOD_System_GetSoftwareFormat Lib "fmodexp.dll" (ByVal system As Long, ByRef samplerate As Long, ByRef format As FMOD_SOUND_FORMAT, ByRef numoutputchannels As Long, ByRef maxinputchannels As Long, ByRef bits As Long) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_SetFrequency Lib "fmodexp.dll" (ByVal channelgroup As Long, ByVal frequency As Single) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_SetPan Lib "fmodexp.dll" (ByVal channelgroup As Long, ByVal pan As Single) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_SetReverbProperties Lib "fmodexp.dll" (ByVal channelgroup As Long, ByRef prop As FMOD_REVERB_CHANNELPROPERTIES) As FMOD_RESULT
Public Declare Function FMOD_ChannelGroup_Set3DAttributes Lib "fmodex.dll" (ByVal channelgroup As Long, ByRef pos As FMOD_VECTOR, ByRef vel As FMOD_VECTOR) As FMOD_RESULT
...
Public Declare Function FMOD_ChannelGroup_GetSpectrum Lib "fmodexp.dll" (ByVal hannelgroup As Long, ByRef spectrumarray As Single, ByVal numvalues As Long, ByVal channeloffset As Long, ByVal windowtype As FMOD_DSP_FFT_WINDOW) As FMOD_RESULT
...
Public Declare Function FMOD_DSP_GetOutput Lib "fmodexp.dll" (ByVal dsp As Long, ByVal ndex As Long, ByRef output As Long) As FMOD_RESULT
