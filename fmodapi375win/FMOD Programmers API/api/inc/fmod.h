...
#define FMOD_VERSION    0x00040035
...
#define FMOD_OPENUSER            0x00000400  /* Opens a user created static sample or stream. */
#define FMOD_OPENMEMORY          0x00000800  /* "name_or_data" will be interpreted as a pointer to memory instead of filename for creating sounds. */
#define FMOD_OPENRAW             0x00001000  /* Will ignore file format and treat as raw pcm.  User may need to declare if data is FMOD_SIGNED or FMOD_UNSIGNED */
...
FMOD_RESULT F_API FMOD_System_SetProxy               (FMOD_SYSTEM *system, const char *proxy);
FMOD_RESULT F_API FMOD_System_GetProxy               (FMOD_SYSTEM *system, char *proxy, int proxylen);
...
FMOD_RESULT F_API FMOD_ChannelGroup_SetFrequency     (FMOD_CHANNELGROUP *channelgroup, float frequency);
